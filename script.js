...
const PRODUCTS_BY_BRAND = {
    ...
    tesla: [
        ...
        { id: 'TSL-003', name: 'Boutons physiques volant Highland', price: 159, modeles: ['Model 3 Highland'], icon: 'fa-circle-dot',
          ...
          descLong: 'Kit de boutons physiques pour restaurer les commandes tactiles du volant Tesla Model 3 Highland (2024+). Deux molettes ABS ingéniérie à clipser sur les pavés tactiles — la commande reste fonctionnelle (scroll, clic), mais avec un feedback mécanique. Clipse sans colle, démontage réversible. Finition satin noir, identique au reste du volant. Pose en 5 min, guide fourni. Garantie légale 2 ans.' },
        ...
        { id: 'TSL-006', name: 'Pack PPF intégral', price: 2890, modeles: ['all'], icon: 'fa-shield',
          ...
          descLong: 'Protection PPF polyuréthane 8 mil intégrale : capot, ailes, portes, pavillon, boucliers, bas de caisse, miroirs et optiques. Protection totale contre rayures, éclats et UV — votre Tesla reste en état concours pendant des années. Finition brillante ou satinée (mate) au choix. Pose par nos installateurs XPERIENCE VISION, 2 jours d\'atelier. Garantie légale 2 ans. Compatible Tesla Model S/3/X/Y.' },
        ...
        { id: 'TSL-012', name: 'Tapis 3D TPE logotés', price: 169, modeles: ['all'], icon: 'fa-road',
          ...
          descLong: 'Set complet de tapis thermoformés TPE avec logo T gaufré, moulés au gabarit exact de votre Tesla (Model S/3/X/Y). Rebords surélevés 30 mm, revers antidérapant sur les points d\'ancrage d\'origine. Résistants aux liquides, UV et écarts de température. Lavables au jet d\'eau. Toutes saisons. Garantie légale 2 ans.' },
    ...
    xpeng: [
        { id: 'XPG-001', name: 'Films écran double dashboard', price: 129, modeles: ['G6', 'G9', 'P7'], icon: 'fa-shield-halved',
          ...
          descLong: 'Set de 2 films hydrogel auto-cicatrisants découpés au gabarit exact des deux écrans du dashboard XPeng G6, G9 et P7 : l\'écran central multimédia et l\'écran cluster conducteur. Dureté 9H, transparence 99 %, traitement anti-traces. Pose sans bulles. Préserve la sensibilité tactile. Garantie légale 2 ans.' },
        { id: 'XPG-002', name: 'Pédales aluminium sport', price: 89, modeles: ['all'], icon: 'fa-shoe-prints',
          ...
          descLong: 'Jeu de 3 pédales sport (accélérateur, frein, repose-pied) en aluminium brossé, picots caoutchouc antidérapants vissés. Pose par clips sur les pédales d\'origine XPeng, démontage réversible. Ajoute une touche sport et améliore le grip. Installation 15 min. Garantie légale 2 ans.' },
        ...
        { id: 'XPG-004', name: 'Capot chargeur sans fil renforcé', price: 79, modeles: ['G6', 'G9'], icon: 'fa-bolt',
          ...
          descLong: 'Remplacement du capot d\'origine du chargeur à induction XPeng G6 et G9 par une version renforcée en ABS chromé brossé. Plus résistant aux rayures et aux chocs, finition premium. Clips d\'origine conservés, pose en 2 min. Préserve la fonction d\'induction. Garantie légale 2 ans.' },
        { id: 'XPG-005', name: 'Module CarPlay sans fil XPeng', price: 249, modeles: ['all'], icon: 'fa-wifi',
          ...
          descLong: 'Adaptateur qui ajoute Apple CarPlay sans fil à votre XPeng — ni câble, ni modification logicielle. Branchement sur le port USB-C de la console centrale, détection automatique du téléphone dès que vous montez à bord. Transfert audio haute qualité, reconnaissance vocale Siri, mises à jour OTA. Compatible XPeng G6, G9 et P7. Garantie légale 2 ans.' },
        { id: 'XPG-006', name: 'Tapis 3D TPE logotés', price: 159, modeles: ['all'], icon: 'fa-road',
          ...
          descLong: 'Set complet de tapis thermoformés TPE moulés au gabarit exact des XPeng G6, G9 et P7. Logo XPeng gaufré, rebords surélevés qui contiennent liquides et boue, revers antidérapant. Résistants aux UV, graisses et écarts de température. Lavables au jet d\'eau. Utilisables toutes saisons. Garantie légale 2 ans.' },
        { id: 'XPG-007', name: 'Films teintés homologués', price: 349, modeles: ['all'], icon: 'fa-window-maximize',
          ...
          descLong: 'Films teintés céramique nanométrique pour vitres arrière + lunette, homologués route. 3 niveaux : 35 %, 20 % ou 5 %. Rejet chaleur -70 %, UV 99 %, anti-éblouissement. Pose atelier XPERIENCE VISION en salle climatisée pour un rendu sans bulles. Garantie légale 2 ans.' },
        ...
        { id: 'XPG-009', name: 'Coque clé premium', price: 49, modeles: ['all'], icon: 'fa-key',
          ...
          descLong: 'Étui cuir véritable cousu main pour la télécommande XPeng G6, G9 et P7. Protège des chocs et patine avec le temps. Dragonne amovible et anneau métallique inclus, 3 coloris (noir, cognac, bleu marine). Garantie légale 2 ans.' },
        { id: 'XPG-010', name: 'Seuils de porte LED « XPeng »', price: 179, modeles: ['all'], icon: 'fa-door-open',
          ...
          descLong: 'Set de 4 seuils de porte en inox 304 brossé avec logo XPeng rétroéclairé LED blanc froid. Allumage automatique à l\'ouverture via le faisceau d\'éclairage courtoisie d\'origine — aucun câblage. Protège les seuils et signe l\'habitacle. Pose adhésive 3M VHB, 10 min. Garantie légale 2 ans.' }
    ],
    bmw: [
        ...
        { id: 'BMW-003', name: 'Habillage console carbone M', price: 349, modeles: ['Série 3', 'Série 5', 'X3', 'X5'], icon: 'fa-layer-group',
          ...
          descLong: 'Habillage console centrale en vinyle 3M Di-Noc finition carbone tissé 3D. Thermoformage à chaud en atelier XPERIENCE VISION pour un rendu parfait sur Série 3, 5, X3 et X5. Résistant aux rayures et stable aux UV, indistinguable d\'une finition M d\'usine. Garantie légale 2 ans.' },
        ...
        { id: 'BMW-005', name: 'Seuils LED illuminés BMW', price: 219, modeles: ['all'], icon: 'fa-door-open',
          ...
          descLong: 'Set de 4 seuils en inox 304 brossé avec logo BMW rétroéclairé LED blanc froid. Allumage auto à l\'ouverture via faisceau courtoisie d\'origine — aucun câblage. Protège les seuils et signe l\'habitacle premium. Pose adhésive 3M VHB, 10 min. Compatible toute la gamme BMW. Garantie légale 2 ans.' },
        { id: 'BMW-006', name: 'Films teintés homologués', price: 349, modeles: ['all'], icon: 'fa-window-maximize',
          desc: 'Films céramiques homologués · 3 teintes · Pose atelier XPERIENCE VISION.',
          descLong: 'Films teintés céramique nanométrique pour vitres arrière + lunette, certifiés CE et homologués route. 3 niveaux : 35 %, 20 % ou 5 %. Rejet chaleur jusqu\'à 70 %, UV 99 %, anti-éblouissement. Pose atelier XPERIENCE VISION en salle climatisée. Garantie légale 2 ans.' },
        { id: 'BMW-007', name: 'Coque clé cuir cousu main', price: 79, modeles: ['all'], icon: 'fa-key',
          ...
          descLong: 'Étui cuir nappa véritable cousu main point sellier pour la télécommande BMW (Display Key et standard). Épaissit le grip et protège des chocs. Finition naturelle qui se patine. 3 coloris disponibles : noir, cognac, bleu marine. Dragonne amovible et anneau métallique. Garantie légale 2 ans.' },
        ...
        { id: 'BMW-009', name: 'Caches valves BMW M', price: 39, modeles: ['all'], icon: 'fa-circle-dot',
          ...
          descLong: 'Jeu de 4 bouchons de valves en aluminium anodisé noir avec logo M tricolore, joint torique étanche qui protège les valves de la poussière et de l\'humidité. Empêche corrosion et fuites lentes d\'air. Clé de serrage incluse. Garantie légale 2 ans.' },
        ...
        { id: 'BMW-011', name: 'Cache moteur alu brossé', price: 199, modeles: ['Série M'], icon: 'fa-gear',
          ...
          descLong: 'Cache moteur en aluminium brossé mis en forme par emboutissage, avec logo M gravé laser. Remplace le cache plastique d\'origine des BMW Série M pour un rendu motorsport et une meilleure dissipation thermique. Clips d\'origine conservés, pose en 5 min. Compatible Série M (M2, M3, M4, M5). Garantie légale 2 ans.' },
    ...
    mercedes: [
        { id: 'MRC-001', name: 'Tapis 3D TPE logotés Mercedes', price: 189, modeles: ['all'], icon: 'fa-road',
          ...
          descLong: 'Set complet de tapis thermoformés TPE haute densité avec étoile Mercedes gaufrée, moulés au gabarit exact de votre véhicule (Classe C, E, S, GLC, GLE, GLS). Rebords surélevés 30 mm, revers antidérapant sur ancrages d\'origine. Résistants aux UV et aux graisses. Lavables au jet. Garantie légale 2 ans.' },
        { id: 'MRC-002', name: 'Films PPF capot', price: 690, modeles: ['all'], icon: 'fa-shield-halved',
          ...
          descLong: 'Film PPF 8 mil polyuréthane auto-cicatrisant sur le capot. Protection invisible contre éclats, UV et sève. Finition brillante qui ravive la peinture Mercedes. Pose atelier XPERIENCE VISION en 3 h. Garantie légale 2 ans. Compatible toute la gamme Mercedes.' },
        ...
        { id: 'MRC-004', name: 'Pédales aluminium AMG', price: 129, modeles: ['all'], icon: 'fa-shoe-prints',
          ...
          descLong: 'Jeu de pédales sport signature AMG en aluminium brossé, picots caoutchouc antidérapants. Pose par clips sur les pédales d\'origine — aucun perçage. Ajoute une touche AMG immédiate au poste de conduite. Installation 15 min. Compatible toute la gamme Mercedes. Garantie légale 2 ans.' },
        { id: 'MRC-005', name: 'Seuils LED illuminés Mercedes', price: 229, modeles: ['all'], icon: 'fa-door-open',
          ...
          descLong: 'Set de 4 seuils en inox 304 brossé avec étoile Mercedes rétroéclairée LED blanc froid ou bleue (au choix). Allumage auto à l\'ouverture via faisceau courtoisie d\'origine. Protège les seuils et apporte une signature visuelle premium. Pose adhésive 3M VHB, 10 min. Garantie légale 2 ans.' },
        { id: 'MRC-006', name: 'Films teintés homologués', price: 349, modeles: ['all'], icon: 'fa-window-maximize',
          desc: 'Films céramiques homologués · 3 teintes · Pose atelier XPERIENCE VISION.',
          descLong: 'Films teintés céramique nanométrique pour vitres arrière + lunette, homologués route. 3 niveaux : 35 %, 20 % ou 5 %. Rejet chaleur jusqu\'à 70 %, UV 99 %. Pose atelier XPERIENCE VISION en salle climatisée. Garantie légale 2 ans.' },
        { id: 'MRC-007', name: 'Coque clé cuir nappa', price: 89, modeles: ['all'], icon: 'fa-key',
          ...
          descLong: 'Étui en cuir nappa véritable cousu main point sellier, épousant parfaitement la télécommande Mercedes. Protège des chocs, se patine avec le temps. 3 coloris au choix (noir, cognac, bleu marine). Dragonne et anneau métallique. Garantie légale 2 ans.' },
        ...
        { id: 'MRC-009', name: 'Étoile éclairée calandre', price: 299, modeles: ['Classe E', 'Classe S', 'GLE', 'GLS'], icon: 'fa-star',
          ...
          descLong: 'Étoile de calandre éclairée LED blanc froid qui s\'allume en même temps que les feux de position. Installation par nos techniciens XPERIENCE VISION avec pose d\'un faisceau dédié sécurisé (fusible intégré). Effet signature premium visible de loin de jour comme de nuit. Compatible Classe E, Classe S, GLE et GLS. Garantie légale 2 ans.' },
        { id: 'MRC-010', name: 'Habillage volant cuir/alcantara', price: 499, modeles: ['all'], icon: 'fa-circle-half-stroke',
          ...
          descLong: 'Regainage complet du volant Mercedes en bi-matière cuir nappa (9h-3h) et Alcantara® (12h-6h), cousu main point sellier avec surpiqûres à votre convenance. Ergonomie améliorée, grip optimal, rendu AMG. Travail dépose / repose 6 h. Compatible toute la gamme Mercedes. Garantie légale 2 ans.' },
    ...
    'range-rover': [
        { id: 'RR-001', name: 'Tapis cuir/TPE logotés', price: 229, modeles: ['all'], icon: 'fa-road',
          ...
          descLong: 'Tapis de sol haut de gamme bi-matière : cuir véritable sur la partie visible (aspect luxe), TPE haute densité sur le pourtour et les rebords (praticité et résistance). Moulés au gabarit exact de votre Range Rover (Velar, Sport, Range Rover). Revers antidérapant et rebords anti-projection. Entretien simple au chiffon humide. Garantie légale 2 ans.' },
        { id: 'RR-002', name: 'Films PPF intégral', price: 2990, modeles: ['all'], icon: 'fa-shield',
          ...
          descLong: 'Protection PPF polyuréthane 8 mil intégrale full-body : capot, ailes, portes, pavillon, boucliers, bas de caisse, miroirs. Totalement transparent, auto-cicatrisant, protège contre éclats, rayures, sève et UV — votre Range reste en état concours. Finition brillante ou satinée (mate) au choix. Pose par nos installateurs XPERIENCE VISION, 2-3 jours d\'atelier. Garantie légale 2 ans. Compatible Velar, Sport et Range Rover.' },
        ...
        { id: 'RR-004', name: 'Marche-pieds rétractables LED', price: 1290, modeles: ['Sport', 'Range Rover'], icon: 'fa-stairs',
          ...
          descLong: 'Marche-pieds électriques rétractables qui se déploient automatiquement à l\'ouverture des portes et se rétractent à la fermeture. Aluminium extrudé antidérapant, LED intégrées blanc froid pour l\'éclairage au sol. Capacité 200 kg par pied. Installation par nos techniciens (1 jour atelier) avec programmation via le CAN bus du véhicule. Compatible Sport et Range Rover. Garantie légale 2 ans.' },
        { id: 'RR-005', name: 'Seuils LED illuminés', price: 249, modeles: ['all'], icon: 'fa-door-open',
          ...
          descLong: 'Set de 4 seuils en inox 304 brossé avec logo Range Rover rétroéclairé LED blanc froid. Allumage auto à l\'ouverture via le faisceau courtoisie d\'origine. Protège les seuils (très exposés sur SUV) et signe l\'habitacle premium britannique. Pose adhésive 3M VHB, 10 min. Garantie légale 2 ans.' },
        { id: 'RR-006', name: 'Films teintés homologués', price: 449, modeles: ['all'], icon: 'fa-window-maximize',
          ...
          descLong: 'Films teintés céramique nanométrique pour vitres arrière + lunette (grandes surfaces Range), homologués route. 3 niveaux : 35 %, 20 % ou 5 %. Rejet chaleur jusqu\'à 70 %, UV 99 %, anti-éblouissement. Pose atelier XPERIENCE VISION en salle climatisée pour un rendu sans bulles. Garantie légale 2 ans.' },
        { id: 'RR-007', name: 'Coque clé cuir cousu main', price: 99, modeles: ['all'], icon: 'fa-key',
          ...
          descLong: 'Étui en cuir véritable pleine fleur cousu main point sellier, épousant la télécommande Range Rover. Cuir sélectionné pour se patiner en beauté avec le temps. 3 coloris au choix (noir, cognac, bleu nuit). Dragonne amovible et anneau métallique en laiton. Garantie légale 2 ans.' },
        ...
        { id: 'RR-009', name: 'Habillage volant cuir/alcantara', price: 549, modeles: ['all'], icon: 'fa-circle-half-stroke',
          ...
          descLong: 'Regainage complet du volant Range Rover en bi-matière cuir nappa (9h-3h) et Alcantara® italien (12h-6h), cousu main point sellier. Surpiqûres contrastées au choix. Ergonomie améliorée, grip optimal, rendu digne des finitions Autobiography. Travail dépose / repose incluse, 6 h d\'atelier. Garantie légale 2 ans.' },
